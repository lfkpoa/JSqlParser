...
public class Revoke implements Statement {
    ...
    public Revoke withRole(String role) {
        this.setRole(role);
        return this;
    }

    public Revoke withPrivileges(List<String> privileges) {
        this.setPrivileges(privileges);
        return this;
    }

    public Revoke withObjectName(String objectName) {
        this.setObjectName(objectName);
        return this;
    }
    
    public Revoke withObjectName(List<String> objectName) {
        this.setObjectName(objectName);
        return this;
    }

    public Revoke withUsers(List<String> users) {
        this.setUsers(users);
        return this;
    }

    public Revoke addPrivileges(String... privileges) {
    ...
    public Revoke addPrivileges(Collection<String> privileges) {
        List<String> collection = Optional.ofNullable(getPrivileges()).orElseGet(ArrayList::new);
        collection.addAll(privileges);
        return this.withPrivileges(collection);
    }

    public Revoke addUsers(String... users) {
    ...
    public Revoke addUsers(Collection<String> users) {
        List<String> collection = Optional.ofNullable(getUsers()).orElseGet(ArrayList::new);
